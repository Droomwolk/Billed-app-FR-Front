...
describe("Given I am connected as an Admin", () => {
  // Lorsque je suis sur la page du tableau de bord, il y a des factures, et il y en a une en attente
  describe("When I am on Dashboard page, there are bills, and there is one pending", () => {
    // Ensuite, FilteredBills par statut en attente devrait retourner 1 facture
  ...
  // Lorsque je suis sur la page du tableau de bord, il y a des factures, et il y en a deux refusées
  describe("When I am on Dashboard page, there are bills, and there is two refused", () => {
    // Ensuite, FilteredBills par statut accepté devrait retourner 2 factures
