...
describe("Given I am connected as an Admin and I am on Dashboard Page", () => {
  // Lorsque les données de la facture sont transmises à DashboardUI
  describe("When bill data is passed to DashboardUI", () => {
    // Ensuite, ils devraient être dans la page
  ...
  // Lorsque la notes de frais attente est transmis à DashboardUI
  describe("When pending bill is passed to DashboardUI", () => {
    // Ensuite, il devrait afficher le bouton et la zone de texte
  ...
  // Lorsque la facture est acceptée, elle est transmise à DashboardUI
  describe("When accepted bill is passed to DashboardUI", () => {
    // Ensuite, il devrait afficher le commentaire de l'administrateur
